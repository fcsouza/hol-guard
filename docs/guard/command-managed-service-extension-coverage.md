...
| --- | --- | --- |
| `command.dns` | Hosted-zone, health-check, query-logging, delegation-set, and traffic-policy deletion through AWS, Google Cloud, and Azure CLIs | List, describe, show, help, and AWS request skeleton generation |
